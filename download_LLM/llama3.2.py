...
ROOT_SAVE_DIR = "/data/home/jinyuehan/LLMBrain/LLMmodel/Llama/llama3.2"
# LLM-Research旗下Llama3.2的标准仓库ID（ModelScope验证通过）
LLAMA32_MODELS = {
    "1B": "LLM-Research/Llama-3.2-1B",    # 对应https://www.modelscope.cn/models/LLM-Research/Meta-Llama-3.2-1B
    "3B": "LLM-Research/Llama-3.2-3B",    # 对应https://www.modelscope.cn/models/LLM-Research/Meta-Llama-3.2-3B
    "11B": "LLM-Research/Llama-3.2-11B-Vision"   # 对应https://www.modelscope.cn/models/LLM-Research/Meta-Llama-3.2-11B
}
...
for model_size, model_repo in LLAMA32_MODELS.items():
    ...
    print(f"\n{'='*50}")
    print(f"开始下载 Llama3.2-{model_size}")
