...
model_path = "/data/home/jinyuehan/LLMBrain/LLMmodel/Llama/llama3.1/70B/LLM-Research/Meta-Llama-3.1-70B"
model_name = model_path.split('/')[-1]  # llama, gemma, mistral, phi-3
# model_name="Llama-3-8B"
# save_dir = f'path-to-save/{model_name}'
save_dir="/data/home/jinyuehan/LLMBrain/12.18/attention_LLM/Llama/llama3.1/70B"
...
tokenizer = AutoTokenizer.from_pretrained(
    ...
    use_fast=True,  # Llama3.1支持fast Tokenizer，无需强制slow
    padding_side="right",
    add_bos_token=True,
    add_eos_token=False
)
# Llama3.1默认有pad_token，无需手动指定，但兜底补充
