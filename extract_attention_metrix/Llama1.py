...
model_path = "/data/home/jinyuehan/LLMBrain/LLMmodel/Llama/llama1/7B/skyline2006/llama-7b"
model_name = model_path.split('/')[-1]  # llama, gemma, mistral, phi-3
# model_name="Llama-3-8B"
# save_dir = f'path-to-save/{model_name}'
save_dir="/data/home/jinyuehan/LLMBrain/12.18/attention_LLM/Llama/llama1/7B"
